...
- Name: e2e\signup.spec.ts >> Fluxo de Cadastro (Sign Up) >> deve exibir erro de validação ao submeter senha fraca
- Location: tests\e2e\signup.spec.ts:31:7
      ...
      - generic [ref=e10]:
        ...
        - generic [ref=e12]:
          - generic [ref=e13]:
            ...
            - textbox "seu@email.com" [ref=e15]: outro@example.com
          - generic [ref=e16]:
            - generic [ref=e17]: Senha
            - textbox "••••••••" [ref=e18]: senhasimples
          - generic [ref=e19]:
            - generic [ref=e20]: Confirmar Senha
            - textbox "••••••••" [active] [ref=e21]: senhasimples
          - generic [ref=e22]:
