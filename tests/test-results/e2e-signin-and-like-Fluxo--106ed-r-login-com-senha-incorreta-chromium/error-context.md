...
- Name: e2e\signin-and-like.spec.ts >> Fluxo de Login (Sign In) >> deve exibir erro ao tentar login com senha incorreta
- Location: tests\e2e\signin-and-like.spec.ts:21:7
      ...
      - generic [ref=e10]:
        ...
        - generic [ref=e12]:
          ...
          - generic [ref=e16]:
            ...
            - textbox "••••••••" [active] [ref=e18]: SenhaErrada@999
